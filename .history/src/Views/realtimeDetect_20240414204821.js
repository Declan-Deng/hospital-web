    ...
    <>
      ...
      <div className="envoBar">
        <div className="envoDisplayPart">
          <FaTemperatureFull style={{ fontSize: "50px", color: "#c67da6" }} />
        ...
        <div className="envoDisplayPart">
          <TbDroplets style={{ fontSize: "50px", color: "#2a8efb" }} />
          <div className="envoText">
            <p>当前室内湿度</p>
            <p>50 %</p>
          </div>
            ...
            <div className="oldInfoDisplay">
              <div className="oldInfoDisplayPart">
                ...
                <div className="oldInfoDisplayPart-sm">
                  <FaTemperatureFull color="#b67292" />
                  <p style={{ color: "#a46889" }}>{oldMan.temperature}</p>
                </div>
              </div>
              ...
              <div className="oldInfoDisplayPart">
                <p>心率</p>
                <div className="oldInfoDisplayPart-sm">
                  <RiHeartPulseFill color="#ff655d" />
                  <p style={{ color: "#ef615a" }}>{oldMan.heartRate}</p>
                </div>
              </div>
              ...
              <div className="oldInfoDisplayPart">
                <p>血氧</p>
                <div className="oldInfoDisplayPart-sm">
                  <MdOutlineBloodtype color="#8cafe2" />
                  <p style={{ color: "#6a87b3" }}>{oldMan.bloodOxygen}</p>
                </div>
              </div>
            </div>
          </div>
